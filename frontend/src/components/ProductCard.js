    ...
    <StyledWrapper data-open={miniOpen}>
      <div className="card">
        ...
        <div className="content">
          ...
          <div className="premium-rating-bar">
            <div className="rating-header">
              <span className="crown">👑</span>
              <span className="rating-title">التقييم الملكي</span>
              <span className="diamond">💎</span>
            </div>
            <div className="luxury-bar-container">
              <div className="luxury-frame">
                <div className="corner-gems">
                  <div className="gem top-left">✨</div>
                  <div className="gem top-right">✨</div>
                  <div className="gem bottom-left">💫</div>
                  <div className="gem bottom-right">💫</div>
                </div>
                <div className="rating-segments">
                  <div className="segment security">
                    <div className="segment-icon">🔒</div>
                    <div className="segment-value">99%</div>
                    <div className="segment-label">أمان</div>
                  </div>
                  <div className="segment speed">
                    <div className="segment-icon">⚡</div>
                    <div className="segment-value">0.1s</div>
                    <div className="segment-label">سرعة</div>
                  </div>
                  <div className="segment quality">
                    <div className="segment-icon">🏆</div>
                    <div className="segment-value">#1</div>
                    <div className="segment-label">جودة</div>
                  </div>
                  <div className="segment satisfaction">
                    <div className="segment-icon">👑</div>
                    <div className="segment-value">VIP</div>
                    <div className="segment-label">مميز</div>
                  </div>
                </div>
            ...
            <div className="rating-footer">
              <span className="status-text">✨ استثنائي ✨</span>
            </div>
          </div>
...
const StyledWrapper = styled.div`
  ...
  /* Premium Rating Bar Styles */
  .card .content .premium-rating-bar {
  ...
  .card .content .premium-rating-bar::before {
    content: '';
    position: absolute;
    top: 0;
    left: 0;
  ...
  .card .content .premium-rating-bar .rating-header {
    display: flex;
    align-items: center;
    justify-content: center;
    gap: 8px;
  ...
  .card .content .premium-rating-bar .crown,
  .card .content .premium-rating-bar .diamond {
    font-size: 16px;
    filter: drop-shadow(0 0 4px rgba(255, 215, 0, 0.6));
  }

  .card .content .premium-rating-bar .rating-title {
    color: #ffd700;
    font-family: 'Tajawal', 'IBM Plex Sans Arabic', 'Cairo', sans-serif;
    font-weight: 700;
    font-size: 0.9rem;
  ...
  .card .content .premium-rating-bar .luxury-frame {
    position: relative;
  ...
  .card .content .premium-rating-bar .corner-gems {
    position: absolute;
    inset: -2px;
    pointer-events: none;
  }

  .card .content .premium-rating-bar .gem {
    position: absolute;
    font-size: 8px;
    animation: twinkle 2s infinite alternate;
  }

  .card .content .premium-rating-bar .gem.top-left { top: 2px; left: 2px; }
  .card .content .premium-rating-bar .gem.top-right { top: 2px; right: 2px; }
  .card .content .premium-rating-bar .gem.bottom-left { bottom: 2px; left: 2px; }
  .card .content .premium-rating-bar .gem.bottom-right { bottom: 2px; right: 2px; }

  .card .content .premium-rating-bar .rating-segments {
    display: grid;
  ...
  .card .content .premium-rating-bar .segment {
    text-align: center;
    padding: 6px 4px;
  ...
  .card .content .premium-rating-bar .segment:hover {
    background: rgba(255, 215, 0, 0.1);
    transform: translateY(-1px);
  }

  .card .content .premium-rating-bar .segment-icon {
    font-size: 12px;
    margin-bottom: 2px;
  }

  .card .content .premium-rating-bar .segment-value {
    color: #ffd700;
    font-weight: 700;
    font-size: 0.7rem;
    line-height: 1;
  ...
  .card .content .premium-rating-bar .segment-label {
    color: #e2e8f0;
    font-size: 0.5rem;
    font-family: 'Tajawal', 'IBM Plex Sans Arabic', 'Cairo', sans-serif;
    font-weight: 500;
  ...
  .card .content .premium-rating-bar .progress-bar {
    position: relative;
    height: 6px;
  ...
  .card .content .premium-rating-bar .progress-fill {
    height: 100%;
    width: 98%;
  ...
  .card .content .premium-rating-bar .sparkles {
    position: absolute;
    top: 0;
    left: 0;
    right: 0;
  ...
  .card .content .premium-rating-bar .sparkle {
    position: absolute;
    font-size: 6px;
    animation: float 3s infinite ease-in-out;
  }

  .card .content .premium-rating-bar .sparkle.s1 {
    left: 20%;
    animation-delay: 0s;
  }

  .card .content .premium-rating-bar .sparkle.s2 {
    left: 50%;
    animation-delay: 1s;
  }

  .card .content .premium-rating-bar .sparkle.s3 {
    left: 80%;
    animation-delay: 2s;
  }

  .card .content .premium-rating-bar .final-score {
    text-align: center;
    margin-bottom: 8px;
  }

  .card .content .premium-rating-bar .score-number {
    color: #ffd700;
    font-size: 1.2rem;
    font-weight: 900;
  ...
  .card .content .premium-rating-bar .score-max {
    color: #94a3b8;
    font-size: 0.8rem;
    font-weight: 600;
  }

  .card .content .premium-rating-bar .rating-footer {
    text-align: center;
  }

  .card .content .premium-rating-bar .status-text {
    color: #ffd700;
    font-family: 'Tajawal', 'IBM Plex Sans Arabic', 'Cairo', sans-serif;
    font-weight: 600;
    font-size: 0.7rem;
